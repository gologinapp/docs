...
1. Download the AppImage file using this [link](https://gologin.com/download)
2. Navigate to your **Downloads** folder
...
- iOS, (iPhone and iPad)
- Chrome OS (can be used in the [Gologin web](/gologin-web-overview) version)

## See also

- [First-time checklist](https://gologin.com/docs/getting-started/setup/first-time-checklist)
- [Gologin Web, Chrome OS](https://gologin.com/docs/general/gologin-web-and-mobile)
