...
<Warning>Using rotating proxies for Amazon seller accounts is a common mistake that leads to account bans. Amazon links accounts by IP -- if your IP rotates, multiple accounts may be flagged as connected.</Warning>