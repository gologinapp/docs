...
keywords: ["cloud browser", "headless browser"]
---

lGologin Cloud Browser lets you run a Gologin (Orbita) browser **in the cloud** and control it from your automation code (Puppeteer / Playwright) using a single **connection URL**.
