...
- Remote browser sessions for Puppeteer/Playwright connections.
...
3. Build the connect URL with `token` and optional `profile`.
...
See current limits and quotas: https://gologin.com/docs/api-reference/limitations/rate-limits
...
Configure proxies through the Proxy API (and related profile settings via REST API): https://gologin.com/docs/api-reference/proxy
