...
Orbita tracks Chrome's version releases. This matters because a browser reporting an outdated version looks suspicious to websites. Gologin updates Orbita regularly, and you can [update individual profiles](/updating-your-browser-profile) to the latest browser version from the profile menu.
