---
title: "Restore browser sessions"
---

Every time you run and close a Gologin profile, the system automatically creates a **session snapshot**.
**Profile history** in Gologin allows you to restore from up to 5 latest sessions.
...
To restore your profile to one of the 5 latest sessions, just click **3 dots on the profile** > **History** > choose the latest known-good session > click **Restore**.

![GoLogin_profile_history.gif](/images/GoLogin_profile_history.gif)
...
4. **Profile non-functional**
    If you can't launch a profile due to any non-proxy-related erros, for example, if the previous session didn't sync correctly.
